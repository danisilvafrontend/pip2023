            ...
            <form id="regProject">                
                ...
                <fieldset class="step">
                    ...
                    <div class="form-group">                    
                        ...
                        <textarea name="message" rows="3" maxlength="70" placeholder="até 70 caracteres"></textarea>
                    </div>
                    <div class="form-group">                    
                        <label for="">PITCH: Qual problema e solução seu negócio aborda?</label>
                        <textarea name="message" rows="2" cols="30" maxlength="150" placeholder="até 150 caracteres"></textarea>
                    </div>
                    <div class="form-group">                    
                    ...
                    <div class="form-group">                    
                        <label for="">Adicione sua apresentação em PDF</label>
