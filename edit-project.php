            ...
            <div class="flex-container">
                <div class="content">                    
                    ...
                    <div id="project-data" class="tabcontent">
                        ...
                        <div class="form-group">                    
                        <label for="">Descreva seu negócio de impacto em uma frase</label>
                            <textarea name="message" rows="3" maxlength="70">Lorem ipsum dolor sit amet consectetur adipisicing elit Lorem ipsum dolor sit amet consectetur adipisicing elit</textarea>
                        </div>
                        <div class="form-group">                    
                            <label for="">PITCH: Qual problema e solução seu negócio aborda?</label>
                            <textarea name="message" rows="2" cols="30" maxlength="150">Lorem ipsum dolor sit amet consectetur adipisicing elit Lorem ipsum dolor sit amet consectetur adipisicing elit</textarea>
                        </div>
                        <div class="form-group">                    
                        ...
                        <div class="form-group">                    
                            <label for="">Alterar sua apresentação em PDF</label>
